...
export async function buildServer(
  ...
  mediaSecret: string,
  automation: { groups: GroupsRepo; scenes: ScenesRepo; runner: SceneRunner },
  ...
  registerAutomationRoutes(app, automation.groups, automation.scenes, automation.runner, control);
